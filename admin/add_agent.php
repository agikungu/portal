				...
				<div class="container">
						...
						?>
							<div class="alert alert-success">
								<strong>Success !</strong> Agent Added Successfully.
							</div>
						<?php
							}
						?>
						...
						?>
							<div class="alert alert-danger">
								<strong>Error !</strong> Agent already exist.
							</div>
						<?php
							}
						?>
				<form id="register_form" name="form1" method="post" action="add_agent_a.php" >
					...
					<div class="form-group">
					  ...
					  <input type="password" class="form-control" id="city" placeholder="Enter your password" name="password" required>
					</div>
					<input type="hidden" class="form-control" name="mode" value="1">
					<p align="center"><button type="submit" class="btn btn-primary" id="butsave">Create  Agent</button></p>
				</form>
				</div>
            </div>
          </div>
